...
│ ├── BNA/
│ │ └── image_files.tif
│ └── ... (folders for all 14 event SiteIDs like CMO, CTO, DKA, etc.)
├── labels0129_256_GroupedByEvents/
│ ├── BEI/
│ │ └── label_files.tif (corresponding masks, value 1 for inundated, 0 for non-inundated)
│ ├── BNA/
│ │ └── label_files.tif
│ └── ... (folders for all 14 event SiteIDs)
└── ... (other files/folders from extraction, including the STAC catalog if desired)
